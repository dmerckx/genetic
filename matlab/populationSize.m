...
qos_adj(i) = (564/result_adj_pop(i,2))*100;
end
...
qos_path(i) = (564/result_path_pop(i,2)*100);
end

plot(popSizes_path,qos_path,'r');

legend('adjacency','path');

xlabel('Population size');
ylabel('Percentage of the optimal solution');

title('Influence of the population size');